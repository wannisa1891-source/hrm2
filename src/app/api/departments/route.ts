...
export async function POST(req: Request) {
  try {
    ...
    const { dept_id, division, dept_name, sub_dept, description, head_emp_id, phone, org_chart_url, sop_url, rules_url } = body;
    ...
    await pool.query(
      'INSERT INTO tbl_departments (dept_id, division, dept_name, sub_dept, description, head_emp_id, phone, org_chart_url, sop_url, rules_url) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)',
      [dept_id, division || null, dept_name, sub_dept || null, description || null, head_emp_id || null, phone || null, org_chart_url || null, sop_url || null, rules_url || null]
    );
