  ...
  try {
    ...
    try {
      ...
      const values: any[] = [
        ...
        (d.dept_id === undefined || d.dept_id === 'undefined') ? existing.dept_id : (d.dept_id && d.dept_id.trim() !== '' && d.dept_id !== 'null') ? d.dept_id : null,
        (d.pos_id === undefined || d.pos_id === 'undefined') ? existing.pos_id : (d.pos_id && d.pos_id.trim() !== '' && d.pos_id !== 'null') ? d.pos_id : null,
