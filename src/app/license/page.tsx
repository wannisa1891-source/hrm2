         ...
         {!isView && license && (
            <div style={{ background: '#fffbeb', padding: '24px', borderRadius: '24px', border: '1px solid #fde68a', width: '100%' }}>
               ...
               <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  <div>
                     <div style={{ fontSize: '11px', fontWeight: 800, color: '#d97706', marginBottom: '4px' }}>เลขที่ใบประกอบวิชาชีพ</div>
      ...
      <table style={{ width: '100%', borderCollapse: 'separate', borderSpacing: '0 8px' }}>
         <thead>
            <tr style={{ textAlign: 'left', color: '#94a3b8', fontSize: '11px', fontWeight: 900, textTransform: 'uppercase' }}>
               <th style={{ padding: '0 16px' }}>เลขใบประกอบวิชาชีพ</th>
                        ...
                        <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
                           ...
                           <div style={{ flex: 1, padding: '48px 64px', overflowY: 'auto', background: '#f8fafc', position: 'relative' }}>
                              ...
                              <div style={{ marginBottom: '40px' }}>
                                 <h2 style={{ margin: 0, fontSize: '32px', fontWeight: 900, color: '#0f172a' }}>บันทึกข้อมูลใบประกอบวิชาชีพ</h2>
                              ...
                              <form onSubmit={handleLicenseSubmit} onKeyDown={(e) => { if (e.key === 'Enter' && (e.target as HTMLElement).tagName !== 'TEXTAREA') e.preventDefault(); }}>
                                 <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '28px', marginBottom: '32px' }}>
                                    ...
                                    <div>
                                       <label style={{ display: 'block', fontSize: '14px', fontWeight: 800, color: '#475569', marginBottom: '10px' }}>ประเภทใบประกอบวิชาชีพ <span style={{ color: '#ef4444' }}>*</span></label>
                                       <ModernSelect 
                                    ...
                                    <div>
                                       <label style={{ display: 'block', fontSize: '14px', fontWeight: 800, color: '#475569', marginBottom: '10px' }}>เลขที่ใบประกอบวิชาชีพ <span style={{ color: '#ef4444' }}>*</span></label>
                                    ...
                                    <div style={{ gridColumn: 'span 2' }}>
                                       <label style={{ display: 'block', fontSize: '14px', fontWeight: 800, color: '#475569', marginBottom: '10px' }}>หลักฐานใบประกอบวิชาชีพ (.pdf, .jpg, .png)</label>
                                 ...
                                 <div style={{ display: 'flex', gap: '16px' }}>
                                    ...
                                    <button type="submit" disabled={submitting} style={{ flex: 2, padding: '16px', borderRadius: '40px', background: '#0f172a', color: '#fff', border: 'none', fontWeight: 800, cursor: 'pointer' }}>{submitting ? 'กำลังบันทึก...' : 'บันทึกข้อมูลใบประกอบวิชาชีพ'}</button>
                                 </div>
                              </form>
                           </div>
                        </div>
               ...
               <div onClick={() => setActiveModal('none')} style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(15, 23, 42, 0.4)', zIndex: 9999, display: 'flex', alignItems: 'center', justifyContent: 'center', backdropFilter: 'blur(12px)', padding: '20px' }}>
                  <div onClick={e => e.stopPropagation()} style={{ background: '#fff', width: '900px', maxHeight: '90vh', borderRadius: '40px', overflow: 'hidden', display: 'flex', boxShadow: '0 40px 80px -15px rgba(0,0,0,0.2)' }}>
                     ...
                     <div style={{ flex: 1, padding: '48px', overflowY: 'auto', position: 'relative' }}>
                        ...
                        <h2 style={{ margin: '0 0 32px 0', fontSize: '24px', fontWeight: 900 }}>รายละเอียดใบประกอบวิชาชีพ</h2>
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px', marginBottom: '32px' }}>
                           <div><div style={{ fontSize: '11px', color: '#94a3b8', fontWeight: 800, textTransform: 'uppercase' }}>เลขที่ใบประกอบวิชาชีพ</div><div style={{ fontSize: '16px', fontWeight: 800, fontFamily: 'monospace' }}>{selectedLicense.license_no || '-'}</div></div>
                        ...
                        {selectedLicense.file_path && (
                           <div style={{ marginBottom: '32px' }}>
                              <a href={selectedLicense.file_path} target="_blank" rel="noreferrer" style={{ display: 'block', background: '#f8fafc', border: '1px solid #e2e8f0', padding: '20px', borderRadius: '24px', textAlign: 'center', textDecoration: 'none', color: '#2563eb', fontWeight: 800 }}>เปิดดูไฟล์สแกนใบประกอบวิชาชีพ</a>
                           </div>
                        )}
                  ...
                  <div onClick={e => e.stopPropagation()} style={{ background: '#fff', padding: '48px', borderRadius: '40px', width: '600px', boxShadow: '0 40px 80px -15px rgba(0,0,0,0.2)' }}>
                     ...
                     <form onSubmit={handleConfigSubmit} onKeyDown={(e) => { if (e.key === 'Enter' && (e.target as HTMLElement).tagName !== 'TEXTAREA') e.preventDefault(); }}>
                        <div style={{ display: 'grid', gap: '24px', marginBottom: '32px' }}>
                           ...
                           <div><label style={{ display: 'block', fontSize: '14px', fontWeight: 800, marginBottom: '8px' }}>ชื่อในใบประกอบวิชาชีพ</label><input required value={configFormData.license_name} onChange={e => setConfigFormData({ ...configFormData, license_name: e.target.value })} style={{ width: '100%', padding: '14px 24px', borderRadius: '40px', border: '1px solid #e2e8f0' }} /></div>
                           <div>
