...
const icons = {
  ...
  // แก้ไขไอคอน finance เป็นตัวอักษร ฿ โดยตรงเพื่อให้ดูไม่ "ใหม่"
  finance: <span style={{ fontSize: '1.2rem', fontWeight: 600 }}>฿</span>,
  ...
  idCard: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="5" width="20" height="14" rx="2" /><path d="M6 10h2" /><path d="M6 14h2" /><path d="M15 10c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2z" /></svg>,
